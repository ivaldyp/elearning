...
class LaporanEkstrakomptabelController extends Controller
{
	use ExcelTraits;
	...
	public function index(Request $request)
	{
		...
		return view('pages.bpadlaporan.ekstrakomptabel')
				->with('koloknow', $kolok)
	...
	public function excel(Request $request)
	{
		...
		$tblname = "bpadlaporandata.dbo.REKON_G" . $year . "_REKAP";
		$query = DB::select( DB::raw("
					IF OBJECT_ID('$tblname') IS NOT NULL
					   BEGIN
						  select 1 as nilai
		...
		// } else {
			...
			$nmtabelawal = "bpadlaporandata.dbo.[REKON" . $splitdurasi[0] . "_G" . $year . "]"; 
			$nmtabelawalrekap = "bpadlaporandata.dbo.[REKON_G" . $year . "_REKAP]"; 
			$nmtabelakhir = "bpadlaporandata.dbo.[REKON" . $splitdurasi[1] . "_G" . $year . "]"; 
			$nmtabelakhirrekap = "bpadlaporandata.dbo.[REKON_G" . $year . "_REKAP]"; 
	...
	public function pdf(Request $request)
	{
		...
		$pdf->loadView('pages.bpadlaporan.preview.ekstrakomptabel', 
						[
							'tahun' => $year,
							'kolok' => $kolok,
							'pd' => $pd,
