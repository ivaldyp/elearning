...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-md-12">
					<form class="form-horizontal" method="POST" action="/laporanbmd/profil/form/lihatdisposisi" data-toggle="validator" enctype="multipart/form-data">
					@csrf
						<div class="panel panel-info">
								...
								<div class="panel-body">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<?php if (is_null($_SESSION['user_laporan']['id_emp'])) : ?>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												...
												<?php if ($_SESSION['user_laporan']['idgroup'] == 'SKPD INTERNAL'): ?>
									...
									<div class="col-md-6">
										<?php if ($_SESSION['user_laporan']['child'] == 1 || is_null($_SESSION['user_laporan']['id_emp'])): ?>
											<div class="form-group">
												...
												<div class="col-md-8">
													...
													@if(is_null($_SESSION['user_laporan']['id_emp']))
											...
											<?php if ($_SESSION['user_laporan']['child'] == 1): ?>
											<div class="form-group">
							...
							<div class="panel-footer">
								<?php if (is_null($_SESSION['user_laporan']['id_emp']) && $opendisposisi[0]['status_surat'] == 'd'): ?>
	...
	<script>
		...
		$(function () {
			...
			$("#no_form").on('change', function(){
				...
				$.ajax({ 
				type: "GET", 
				url: "/laporanbmd/profil/ceknoform",
