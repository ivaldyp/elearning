			...
			<div class="row ">
				...
				<div class="col-md-10" >
					...
					<div class="panel panel-info">
						<div class="panel-heading">Eksrakomptabel</div>
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
								<div class="row" style="margin-bottom: 10px">
									<form method="GET" action="/laporanbmd/laporan/ekstrakomptabel" class="form-horizontal">
								...
								<hr>	
								<div class="row">
									<form method="GET" action="/laporanbmd/laporan/ekstrakomptabel/pdf" class="form-horizontal">
										@csrf
		...
		$(function () {
			...
			$('.btnExcel').on('click', function () {
			    // alert(this.id); // or alert($(this).attr('id'));
   				...
   				var url = "/laporanbmd/laporan/ekstrakomptabel/excel?"+
   							"tahun="+tahun+"&"+
   							"wilayah="+wilayah+"&"+
   							"laporan="+laporan+"&"+
							"durasi="+durasi+"&"+
			...
			$('.btnPdf').on('click', function () {
			    // alert(this.id); // or alert($(this).attr('id'));
   				...
   				var url = "/laporanbmd/laporan/ekstrakomptabel/pdf?"+
   							"tahun="+tahun+"&"+
   							"wilayah="+wilayah+"&"+
   							"laporan="+laporan+"&"+
							"durasi="+durasi+"&"+
