...
@section('css')
	...
	<!-- Bootstrap -->
	<link type="text/css" rel="stylesheet" href="{{ ('/elearning/public/css/bootstrap.min.css') }}" />

	<!-- Owl Carousel -->
	<link type="text/css" rel="stylesheet" href="{{ ('/elearning/public/css/owl.carousel.css') }}" />
	<link type="text/css" rel="stylesheet" href="{{ ('/elearning/public/css/owl.theme.default.css') }}" />

	<!-- Font Awesome Icon -->
	<link rel="stylesheet" href="{{ ('/elearning/public/css/font-awesome.min.css') }}" />

	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="{{ ('/elearning/public/css/style.css') }}" />

	<link rel="stylesheet" href="{{ ('/elearning/public/tree/mgaccordion.css') }}" />
@endsection
...
@section('js')
	...
	<!-- jQuery Plugins -->
	<script src="{{ ('/elearning/public/js/jquery.min.js') }}"></script>
	<script src="{{ ('/elearning/public/js/bootstrap.min.js') }}"></script>
	<script src="{{ ('/elearning/public/js/owl.carousel.min.js') }}"></script>
	<script src="{{ ('/elearning/public/js/jquery.stellar.min.js') }}"></script>
	<script src="{{ ('/elearning/public/js/main.js') }}"></script>

	<!-- <script src='http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js'></script> -->
	<script src="{{ ('/elearning/public/js/jquery.zoom.js') }}"></script>
	...
	<!-- Accordion js -->
	<script src="{{ ('/elearning/public/tree/mgaccordion.js') }}"></script>
	<script type="text/javascript">
